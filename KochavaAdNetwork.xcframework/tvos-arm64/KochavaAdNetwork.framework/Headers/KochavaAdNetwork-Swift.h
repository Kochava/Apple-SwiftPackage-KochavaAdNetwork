...
#ifndef KOCHAVAADNETWORK_SWIFT_H
#define KOCHAVAADNETWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="KochavaAdNetwork",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class KVAProduct;

/// A class which defines the adnetwork product.
...
/// Defines the parameters for the adnetwork product.
SWIFT_CLASS("_TtC16KochavaAdNetwork25KVAAdNetworkProductParams")
@interface KVAAdNetworkProductParams : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
